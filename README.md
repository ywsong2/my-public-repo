...
graph TD
    ...
    subgraph Option_2 [Option 2: Re-create & Reset]
        A1["<b>1. Delete Old Local Branch</b><br/>git branch -D release-branch"]
        A1 --> A2["<b>2. Create New Orphan</b><br/>git checkout --orphan release-branch"]
        A2 --> A3["<b>Result:</b><br/>Exactly 1 Clean Commit"]
    end

    subgraph Option_1 [Option 1: Keep & Update]
        B1["<b>1. Switch to Release</b><br/>git checkout release-branch"]
        B1 --> B2["<b>2. Sync Files Only</b><br/>git checkout main -- ."]
        B2 --> B3["<b>Result:</b><br/>Clean Release History<br/>(v1, v2, v3...)"]
    end

    Choice -->|Fresh Start| A1
    Choice -->|Incremental| B1

    A3 --> Push["<b>Final Step: Force Push</b><br/>"]
    B3 --> Push
    Push --> Final((<b>Public Repo<br/>Updated!</b>))

    %% Styling for better visibility
    style Option_2 fill:#fff4dd,stroke:#d4a017,stroke-width:2px
    style Option_1 fill:#e1f5fe,stroke:#01579b,stroke-width:2px
